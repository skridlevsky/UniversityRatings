<template>
  ...
  <div class="grid gap-5 row-gap-8 lg:grid-cols-2">
    <div class="flex flex-col justify-center">
      <div class="max-w-xl mb-6">
        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
          Centralizētas atsauksmes<br class="hidden md:block" />
          par
          <span class="inline-block text-indigo-600">Latvijas universitātēm</span>
        </h2>
      </div>
      <a href="/" aria-label="" class="inline-flex items-center font-semibold transition-colors duration-200 text-indigo-600 hover:text-indigo-600">
        Apskatīt
    ...
    <div class="relative">
      <svg class="absolute w-full text-teal-accent-700" fill="currentColor" viewBox="0 0 600 392">
      ...
      <svg class="relative w-full text-indigo-600" fill="currentColor" viewBox="0 0 600 392">
